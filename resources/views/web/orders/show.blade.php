    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div class="lg:col-span-2 space-y-6">
                ...
                {{-- Shipping Address --}}
                <div class="card p-6">
                    <h2 class="font-semibold text-chocolate-600 mb-3">Alamat Pengiriman</h2>
                    <p class="body-text">{{ $order->shipping_address }}</p>
                    @if($order->phone)
                        <p class="body-text mt-2 flex items-center gap-2">
                            <svg class="w-4 h-4 text-chocolate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                            {{ $order->phone }}
                        </p>
                    @endif
                </div>
