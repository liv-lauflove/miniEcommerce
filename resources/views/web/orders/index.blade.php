<x-layouts.web title="My Orders">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h1 class="text-2xl md:text-3xl font-bold text-oxford-900 mb-8">My Orders</h1>
        ...
        @if($orders->isEmpty())
            <div class="card p-12 text-center">
                ...
                <h3 class="font-semibold text-oxford-900 text-lg mb-2">No orders yet</h3>
                        ...
                        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
                            <div>
                                <div class="flex items-center gap-3 flex-wrap">
                                    <span class="font-semibold text-oxford-900">{{ $order->invoice_number }}</span>
                            ...
                            <div class="text-right">
                                <p class="text-lg font-bold text-oxford-900">{{ $order->formatted_total }}</p>
