        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <aside class="lg:w-64 flex-shrink-0">
                <form method="GET" action="{{ route('shop') }}" class="card p-6 space-y-6 sticky top-24">
                    <div>
                        <h3 class="font-semibold text-chocolate-600 mb-3 text-sm">Search</h3>
                        <input type="text" name="search" value="{{ request('search') }}" placeholder="Search products..." class="form-input text-sm">
                    </div>

                    <div>
                        <h3 class="font-semibold text-chocolate-600 mb-3 text-sm">Category</h3>
                    ...
                    <div>
                        <h3 class="font-semibold text-chocolate-600 mb-3 text-sm">Price Range</h3>
                    ...
                    <div>
                        <h3 class="font-semibold text-chocolate-600 mb-3 text-sm">Sort By</h3>
            ...
            <div class="flex-1">
                ...
                @if($products->isEmpty())
                    <div class="card p-12 text-center">
                        ...
                        <h3 class="font-semibold text-chocolate-600 mb-1">No products found</h3>
