            ...
            <table class="table">
                ...
                <tbody>
                    @forelse($orders as $order)
                        <tr>
                            <td class="font-medium text-chocolate-600">{{ $order->invoice_number }}</td>
                            ...
                            <td class="text-right">
                                <a href="{{ route('admin.orders.show', $order->id) }}" class="btn-icon text-gray-400 hover:text-chocolate-500">
