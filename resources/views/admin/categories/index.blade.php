<x-layouts.admin title="Categories">
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-xl font-bold text-chocolate-600">Categories</h1>
            ...
            <table class="table">
                ...
                <tbody>
                    @forelse($categories as $category)
                        <tr>
                            <td class="font-medium text-chocolate-600">{{ $category->name }}</td>
                            ...
                            <td class="text-right">
                                <div class="flex items-center justify-end gap-1">
                                    <form method="POST" action="{{ route('admin.categories.update', $category->id) }}" class="flex gap-1">
                                        ...
                                        <button type="submit" class="btn-icon text-gray-400 hover:text-chocolate-500">
